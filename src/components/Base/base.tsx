                    ...
                    <p>
                        <span>
                          I'm a Senior <span style={{
                            ...
                            <span className="highlight font-bold"> Frontend Engineer</span> who ships <span
                            style={{color: '#000'}} className="italic font-bold">Production-ready</span> UIs.
                        </span>
                    </p>
                </div>
            ...
            <nav>
                <ul>
                    ...
                    <li className={menu[2]}>
                        <small>
                            02
                            <a href="https://calendly.com/thaniessy/new-meeting" target="_blank" rel="noopener noreferrer">
                                <img src={navLine} alt="menu bullet"/> CONTACT <img className="w-4 h-4" src={arrow}
                                                                                 alt="pointer"/>
                            </a>
                        </small>
                    </li>
